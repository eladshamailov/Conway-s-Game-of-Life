...
;;; with co-routine indexes.
        global init_co, start_co, end_co, resume,atoi,cellAssemblyHelper
	extern WorldWidth,WorldLength,t,k,decLengthWidth,incY
...
cellAssemblyHelper:
	...
	pop eax
        ...
        call resume
        pop eax
	add dword[WorldWidth],1
        mov ecx, dword[WorldWidth]
        dec dword[WorldWidth]
	ret
